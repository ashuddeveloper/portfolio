...
export default function PlayPage() {
  ...
  return (
    ...
    >
      ...
      <a href={(process.env.NEXT_PUBLIC_BASE_PATH || "") + "/"} style={{ position: "absolute", bottom: 28, left: 28, background: INK, color: BG, textDecoration: "none", fontWeight: 700, fontSize: 15, padding: "14px 24px", borderRadius: 100 }}>← Back to site</a>
